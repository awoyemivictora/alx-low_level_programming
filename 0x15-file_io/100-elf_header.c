...
void print_type(unsigned char e_type, unsigned char *e_ident);
 ...
 * @e_ident: A pointer to an array contantaing the ELF class
 */
 ...
 * @e_indent: A pointer to an array containing the ELF version
 */
 ...
 * @e_ident: A poniter to an array containing the ELF class
 */
