...
/**
 * wildcmp - comares two strings recursively
 * checking for wildcards expansion
 * @s1: first string to compare
 * @s2: second string to compare
 *
 * Return: 1 if the strings can be considered idential
 * otherwise 0
 */
...
int wildcmp(char *s1, char *s2)
{
	 ...
	 * convert non-zero to 1, keeps 0 ata 0, return
	 */
	if (*s2 == '*')
	{
		s2 = move(s2);
 ...
 * @s2: second string
 *
 * Return: The value of wildcmp() or of itself
 */
